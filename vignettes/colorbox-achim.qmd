...
```{r colorbox}
#| echo: false
colorbox <- function(text, color = text, maincolor = "#212529", bgcolor = "white") {
  ## Arguments:
...
**Named colors:** This is `r colorbox("black")` or `r colorbox("yellow")`.

**Hex colors:** This is `r colorbox("orange", palette.colors()[2])` and `r colorbox("bluishgreen", palette.colors()[4])` from the Okabe-Ito palette.
